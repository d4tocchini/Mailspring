...
*/
  ...
  class Message extends ModelWithMetadata {
    ...
    static defineAttributes(Attribute) {
      ...
      Attribute('Collection', { modelKey: 'to',
        itemClass: Contact,
      })
      Attribute('Collection', { modelKey: 'cc',
        itemClass: Contact,
      })
      Attribute('Collection', { modelKey: 'bcc',
        itemClass: Contact,
      })
      Attribute('Collection', { modelKey: 'from',
        itemClass: Contact,
      })
      Attribute('Collection', { modelKey: 'replyTo',
        itemClass: Contact,
      })
      Attribute('DateTime', { modelKey: 'date',
        queryable: true,
      })
      Attribute('JoinedData', { modelTable: 'MessageBody',
        modelKey: 'body',
      })
      Attribute('Collection', { modelKey: 'files',
        itemClass: File,
      })
      Attribute('Boolean', { modelKey: 'unread',
        queryable: true,
      })
      Attribute('Collection', { modelKey: 'events',
        itemClass: Event,
      })
      ...
      Attribute('String', { modelKey: 'threadId',
        queryable: true,
      })
      Attribute('String', { modelKey: 'headerMessageId', jsonKey: 'hMsgId',
        queryable: true,
      })
      Attribute('String', { modelKey: 'subject',
      })
      Attribute('Boolean', { modelKey: 'draft',
        queryable: true,
      })
      Attribute('Boolean', { modelKey: 'pristine',
        queryable: false,
      })
      Attribute('Number', { modelKey: 'version', jsonKey: 'v',
        queryable: true,
      })
      Attribute('String', { modelKey: 'replyToHeaderMessageId', jsonKey: 'rthMsgId', })
      Attribute('String', { modelKey: 'forwardedHeaderMessageId', jsonKey: 'fwdMsgId', })
  ...
  module.exports = ModelWithMetadata.setup(Message)