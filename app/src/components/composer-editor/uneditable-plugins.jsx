...
const UNEDITABLE_TYPE = 'uneditable';
const UNEDITABLE_TAGS = ['table', 'img', 'center', 'signature'];
...
module.exports.UNEDITABLE_TYPE = UNEDITABLE_TYPE
module.exports.UNEDITABLE_TAGS = UNEDITABLE_TAGS