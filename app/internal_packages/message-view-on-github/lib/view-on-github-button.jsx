...
Unlike a traditional React application, components herein have very few
...
not what React components should be doing. A component's only
...
module.exports = class ViewOnGithubButton extends React.Component {
  ...
  */
  ...
  /** ** Super common Component private methods ****
  /*
  * An extremely common pattern for all components are the methods
