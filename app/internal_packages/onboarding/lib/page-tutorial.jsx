...
const Steps = [
  ...
  },
  {
    ...
    description:
      `With activity tracking, you’ll know as soon as someone reads your message. Sending to a group? ${PRODUCT_NAME} shows you which recipients opened your email so you can follow up with precision.`,
    x: 12.8,
    y: 1,
    xDot: 15,
    yDot: 5.1,
  },
  {
    ...
    description:
      `Snooze emails to return at any time that suits you. Schedule messages to send at the ideal time. ${PRODUCT_NAME} makes it easy to control the fabric of spacetime!`,
    x: 5.5,
    y: 23.3,
    xDot: 10,
    yDot: 25.9,
...
module.exports = class TutorialPage extends React.Component {
